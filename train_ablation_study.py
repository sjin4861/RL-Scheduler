...
def main():
    ...
    for condition in conditions:
        ...
        tensorboard_log = f"./tensorboard/ablation_study/{model_name}"
        ...
        checkpoint_callback = CheckpointCallback(
            ...
            save_path='./models/ablation_study/',
        ...
        if algo == "MaskablePPO":
            eval_callback = MaskableEvalCallback(
                eval_env=env,
                best_model_save_path=f'./models/ablation_study/best_{model_name}',
                log_path=f'./logs/ablation_study/{model_name}_eval',
                eval_freq=10000,
                n_eval_episodes=5,
                deterministic=False,
                render=False
        ...
        # 디렉토리 생성
        os.makedirs('./models/ablation_study/', exist_ok=True)
        os.makedirs('./tensorboard/ablation_study/', exist_ok=True)
        os.makedirs('./logs/ablation_study/', exist_ok=True)
